package com.optica.service_auth.service;
...
import com.optica.service_auth.model.Rol;
import com.optica.service_auth.model.Usuario;
import com.optica.service_auth.repository.UsuarioRepository;
...
public class AuthService {
    ...
    public String login(String username, String password){
        ...
        if(passwordEncoder.matches(password, user.getContrasena())){
            ...
            return jwtService.gererarToken(username, roles);
        }
